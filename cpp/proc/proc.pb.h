...
inline const ::google::protobuf::RepeatedPtrField<::std::string>& ProcEnvProto::sigmapath()
...
inline const ::google::protobuf::RepeatedPtrField<::std::string>& ProcEnvProto::kernels()
    const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::google::protobuf::RepeatedPtrField<::std::string>& ProcProto::args()
    const ABSL_ATTRIBUTE_LIFETIME_BOUND {
