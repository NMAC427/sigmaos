...
inline const ::google::protobuf::RepeatedPtrField<::std::string>& SigmaLastMountRep::path1()
...
inline const ::google::protobuf::RepeatedPtrField<::std::string>& SigmaLastMountRep::path2()
    const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::google::protobuf::RepeatedPtrField<::std::string>& SigmaMountsRep::endpoints()
    const ABSL_ATTRIBUTE_LIFETIME_BOUND {
