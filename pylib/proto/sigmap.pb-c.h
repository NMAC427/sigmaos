...
/* Generated from: sigmap.proto */

#ifndef PROTOBUF_C_sigmap_2eproto__INCLUDED
#define PROTOBUF_C_sigmap_2eproto__INCLUDED
...
typedef struct TqidProto TqidProto;
typedef struct Tprincipal Tprincipal;
typedef struct TstatProto TstatProto;
typedef struct Taddr Taddr;
typedef struct SecretProto SecretProto;
typedef struct TendpointProto TendpointProto;
typedef struct TfenceProto TfenceProto;
typedef struct Tversion Tversion;
typedef struct Rversion Rversion;
typedef struct Tauth Tauth;
typedef struct Rauth Rauth;
typedef struct Tattach Tattach;
typedef struct Tattach__SecretsEntry Tattach__SecretsEntry;
typedef struct Rattach Rattach;
typedef struct Rerror Rerror;
typedef struct Twalk Twalk;
typedef struct Rwalk Rwalk;
typedef struct Topen Topen;
typedef struct Ropen Ropen;
typedef struct Tcreate Tcreate;
typedef struct Rcreate Rcreate;
typedef struct TreadF TreadF;
typedef struct Rread Rread;
typedef struct TwriteF TwriteF;
typedef struct Rwrite Rwrite;
typedef struct Tclunk Tclunk;
typedef struct Rclunk Rclunk;
typedef struct Tremove Tremove;
typedef struct Rremove Rremove;
typedef struct Trstat Trstat;
typedef struct Rrstat Rrstat;
typedef struct Twstat Twstat;
typedef struct Rwstat Rwstat;
typedef struct Twatch Twatch;
typedef struct Rwatch Rwatch;
typedef struct Trenameat Trenameat;
typedef struct Rrenameat Rrenameat;
typedef struct Tgetfile Tgetfile;
typedef struct Tputfile Tputfile;
typedef struct Tdetach Tdetach;
typedef struct Rdetach Rdetach;
typedef struct Theartbeat Theartbeat;
typedef struct Theartbeat__SidsEntry Theartbeat__SidsEntry;
typedef struct Rheartbeat Rheartbeat;
typedef struct Rheartbeat__SidsEntry Rheartbeat__SidsEntry;
typedef struct Tremovefile Tremovefile;
typedef struct Twriteread Twriteread;
...
#endif  /* PROTOBUF_C_sigmap_2eproto__INCLUDED */
