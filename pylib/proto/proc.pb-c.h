...
/* Generated from: proc.proto */

#ifndef PROTOBUF_C_proc_2eproto__INCLUDED
#define PROTOBUF_C_proc_2eproto__INCLUDED
...
typedef struct ProcSeqno ProcSeqno;
typedef struct ProcEnvProto ProcEnvProto;
typedef struct ProcEnvProto__EtcdEndpointsEntry ProcEnvProto__EtcdEndpointsEntry;
typedef struct ProcEnvProto__SecretsMapEntry ProcEnvProto__SecretsMapEntry;
typedef struct ProcProto ProcProto;
typedef struct ProcProto__EnvEntry ProcProto__EnvEntry;
...
struct  ProcEnvProto__EtcdEndpointsEntry
{
  ProtobufCMessage base;
  char *key;
...
struct  ProcEnvProto__SecretsMapEntry
{
  ProtobufCMessage base;
  char *key;
  SecretProto *value;
...
#endif  /* PROTOBUF_C_proc_2eproto__INCLUDED */
