...
/* Generated from: spproxy.proto */

#ifndef PROTOBUF_C_spproxy_2eproto__INCLUDED
#define PROTOBUF_C_spproxy_2eproto__INCLUDED
...
typedef struct SigmaInitReq SigmaInitReq;
typedef struct SigmaNullReq SigmaNullReq;
typedef struct SigmaRealmReq SigmaRealmReq;
typedef struct SigmaCloseReq SigmaCloseReq;
typedef struct SigmaErrRep SigmaErrRep;
typedef struct SigmaPathReq SigmaPathReq;
typedef struct SigmaStatRep SigmaStatRep;
typedef struct SigmaCreateReq SigmaCreateReq;
typedef struct SigmaFdRep SigmaFdRep;
typedef struct SigmaRenameReq SigmaRenameReq;
typedef struct SigmaDataRep SigmaDataRep;
typedef struct SigmaPutFileReq SigmaPutFileReq;
typedef struct SigmaSizeRep SigmaSizeRep;
typedef struct SigmaReadReq SigmaReadReq;
typedef struct SigmaWriteReq SigmaWriteReq;
typedef struct SigmaSeekReq SigmaSeekReq;
typedef struct SigmaClntIdRep SigmaClntIdRep;
typedef struct SigmaFenceReq SigmaFenceReq;
typedef struct SigmaMountTreeReq SigmaMountTreeReq;
typedef struct SigmaLastMountRep SigmaLastMountRep;
typedef struct SigmaMountReq SigmaMountReq;
typedef struct SigmaMountRep SigmaMountRep;
typedef struct SigmaMountsRep SigmaMountsRep;
...
#endif  /* PROTOBUF_C_spproxy_2eproto__INCLUDED */
