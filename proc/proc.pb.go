...
type ProcProto struct {
	...
	ForkProc *ForkProcProto `protobuf:"bytes,9,opt,name=forkProc,proto3" json:"forkProc,omitempty"`
}
...
var file_proc_proc_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xee, 0x02, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x63, 0x50, 0x72,
	...
	0x6e, 0x74, 0x12, 0x2a, 0x0a, 0x08, 0x66, 0x6f, 0x72, 0x6b, 0x50, 0x72, 0x6f, 0x63, 0x18, 0x09,
...
var file_proc_proc_proto_goTypes = []interface{}{
	...
	(*ForkProcProto)(nil),         // 3: ForkProcProto
	...
	nil,                           // 8: ForkProcProto.ZygoteEnvEntry
...
var file_proc_proc_proto_depIdxs = []int32{
	...
	11, // 7: ProcProto.blob:type_name -> Blob
	3,  // 8: ProcProto.forkProc:type_name -> ForkProcProto
	8,  // 9: ForkProcProto.zygoteEnv:type_name -> ForkProcProto.ZygoteEnvEntry
	12, // 10: ProcEnvProto.EtcdEndpointsEntry.value:type_name -> TendpointProto
	13, // 11: ProcEnvProto.SecretsMapEntry.value:type_name -> SecretProto
	12, // 12: ProcEnvProto.CachedEndpointsEntry.value:type_name -> TendpointProto
